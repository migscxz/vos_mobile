  ...
  Future<void> _showFilterMenu() async {
    final selected = await showModalBottomSheet<LeaveFilter>(
      ...
      builder: (ctx) {
        ...
        final visible = LeaveFilter.values.toList(); // includes All + Cancelled if in enum
        return Material(
          color: cs.surface,
          child: ListView(
            shrinkWrap: true,
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            "${header.leavePeriodLabel} • ${header.totalDaysLabel} • ${header.leaveType.label}",
                ...
                const SizedBox(height: 12),
                Text(
                  header.reason.trim().isEmpty ? "—" : header.reason,
                  style: theme.textTheme.bodySmall?.copyWith(
                    color: cs.onSurfaceVariant,
                    fontWeight: FontWeight.w700,
                  ),
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 12),
            Text(
              query.trim().isEmpty ? "No leave requests found." : "No results for '$query'.",
